...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=dizel69&label=Profile%20views&color=2F81F7&style=flat" alt="profile views" />
  <img src="https://img.shields.io/badge/ТвГУ-магистратура-2F81F7?style=flat" alt="TvSU" />
  <img src="https://img.shields.io/badge/фокус-Kubernetes-326CE5?style=flat&logo=kubernetes&logoColor=white" alt="k8s" />
</p>
...
DevOps-инженер и разработчик: автоматизирую инфраструктуру, пишу сервисы на **Python/Go**, применяю **ML** там, где это даёт пользу в проде.  
Сейчас в магистратуре ТвГУ — делаю ВКР по прогнозированию аномалий в мониторинге. До этого защитил бакалаврский диплом по банковскому скорингу.

**Что умею на практике:** IaC (Terraform, Ansible), контейнеры и оркестрация, мониторинг (Zabbix / Prometheus / Grafana), микросервисы, CI/CD, классический ML и чуть железа на ESP32.
...
<p align="center">
  <img width="100%" src="https://github-readme-activity-graph.vercel.app/graph?username=dizel69&bg_color=00000000&color=8B949E&line=2F81F7&point=58A6FF&area=true&hide_border=true" alt="Contribution Graph" />
</p>
...
**Диссертации**
- 🎓 **[microservice-anomaly-monitor](https://github.com/Dizel69/microservice-anomaly-monitor)** — магистерская ВКР: модель мониторинга на ML, прогноз сбоев по метрикам
- 🏦 **[BankScoring](https://github.com/Dizel69/BankScoring)** — бакалаврский диплом: ансамбль моделей для банковского скоринга

**Университет и пет-проекты**
- 📚 **[University Telegram Scheduler](https://github.com/Dizel69/University_Telegram_Sheduler)** — прод для группы: календарь, домашка, напоминания в Telegram (FastAPI + React + Docker + Prometheus/Grafana)
- 🌱 **[Homemade Plant Humidity Sensor](https://github.com/Dizel69/Homemade_Plant_Humidity_Sensor)** — автономный монитор влажности почвы на ESP32 (T-Display-S3)
- 🏫 **[ECM_AND_Program](https://github.com/Dizel69/ECM_AND_Program)** — учебные лабы и проекты ТвГУ

**Инфра**
- 🏁 **[Infra-XSoft](https://github.com/Dizel69/Infra-XSoft)** — олимпиада DevOps: Terraform + Ansible (FreeIPA, GitLab, K8s, Ceph, мониторинг, Moodle, VyOS)
- 📡 **[ansible-zabbix-agent](https://github.com/Dizel69/ansible-zabbix-agent)** — Ansible-роли для офлайн-установки Zabbix Agent
- 🤖 **[DeepLearning](https://github.com/Dizel69/DeepLearning)** — практика по глубокому и машинному обучению
- 🛠 **[OtherPrograms](https://github.com/Dizel69/OtherPrograms)** — эксперименты и скрипты (из них позже вынесу bash в отдельный репозиторий)
...
[![VK](https://img.shields.io/badge/ВКонтакте-%232E87FB.svg?style=for-the-badge&logo=vk&logoColor=white)](https://vk.com/dizel69l)
